...
INSERT INTO sql_queries (id, name, age, gender, color, temperament, alive)
     VALUES ("Melissa", female, purple, sleepy, true);
INSERT INTO sql_queries (id, name, age, gender, color, temperament, alive)
     VALUES ("Grinch", male, green, angery, true);
INSERT INTO sql_queries (id, name, age, gender, color, temperament, alive)
     VALUES ("Wendy", female, turquoise, happy, female, true);
INSERT INTO sql_queries (id, name, age, gender, color, temperament, alive)
     VALUES (null, male, brown, happy, true);